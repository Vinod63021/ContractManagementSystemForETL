...
%>
    ...
    <form method="get" action="<%= request.getContextPath() %>/downloadComplaintCSV">
    <button class="btn btn-success mb-3"><i class="fa fa-download"></i> Download Complaints</button>
</form>
